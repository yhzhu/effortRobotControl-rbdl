...
import { FlakesTexture } from '../threejs/FlakesTexture.js';
import * as BufferGeometry from '../threejs/BufferGeometryUtils.js';
/*
    ...
    parse(content) {
        ...
        function processMaterial(node) {
            ...
            const normalMap3 = new THREE.CanvasTexture( new FlakesTexture() );
					...
					normalMap3.repeat.x = 0.1;
					normalMap3.repeat.y = 0.1;
                            ...
                            loadMeshCb(filePath, manager, (obj, err) => {
                                ...
                                if (err) {
                                    ...
                                    if (obj) {
										...
										//material.color.setRGB(218,76,0)
										//material.flatShading = false
										//material.specular.setRGB(0.2,0.2,0.2)
										//material.medalness = 100
        ...
        switch (ext) {
            ...
            case 'stl':
                new STLLoader(manager).load(
                    path,
                    result => {
                        //result = BufferGeometry.mergeVertices(result,0.001);
                        result = BufferGeometry.toCreasedNormals(result, Math.PI / 15 /* 60 degrees */)
                        var mesh = new THREE.Mesh(result, null);
                        done(mesh);
                    },
                    null,
                    err => done(null, err),
